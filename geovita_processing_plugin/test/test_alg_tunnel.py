...
class TestBegrensSkadeTunnel(unittest.TestCase):
    ...
    def setUp(self):   
        ...
        self.tunnel_layer = QgsVectorLayer(str(self.tunnel_layer_path), 'test_tunnel', 'ogr')
    ...
    def test_algorithm_execution(self):
        ...
        results = processing.run("geovita:begrensskadetunnel", self.params, feedback=feedback, context=context)
