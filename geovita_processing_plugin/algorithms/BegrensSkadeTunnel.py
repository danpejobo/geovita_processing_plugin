...
class BegrensSkadeTunnel(GvBaseProcessingAlgorithms):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        if reproject_is_needed(source_building_poly, output_proj):
            ...
            try:
                source_building_poly, _ = reproject_layers(output_proj, vector_layer=source_building_poly, raster_layer=None, context=context, logger=self.logger)
        ...
        if reproject_is_needed(source_tunnel_poly, output_proj):
            ...
            try:
                source_tunnel_poly, _ = reproject_layers(output_proj, vector_layer=source_tunnel_poly, raster_layer=None, context=context, logger=self.logger)
            except Exception as e:
